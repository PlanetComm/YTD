<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TotalINV.aspx.cs" Inherits="YTD.TotalINV" %>
...
<body>
  ...
  <telerik:RadScriptManager ID="RadScriptManager1" Runat="server">
    ...
    <tr>
    <td align="left" style="width:50%;"><asp:Label ID="Label1" runat="server" Text="[ Invoice Report ]" 
     ...
     <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Width="100%" 
        ...
        <telerik:RadGrid ID="RadNested" runat="server" AutoGenerateColumns="False" 
           ...
           AllowSorting="True" 
            ...
            <ExportSettings FileName="Invoice">
            </ExportSettings>
            ...
            UniqueName="clnInvNumber" Aggregate="Count" AutoPostBackOnFilter="True" 
                    ...
                    <telerik:GridBoundColumn AutoPostBackOnFilter="True" 
                     ...
                     <telerik:GridBoundColumn AutoPostBackOnFilter="True" 
                        CurrentFilterFunction="Contains" DataField="SalesGroupName" 
                        FilterControlAltText="Filter clnSG column" HeaderText="SG-Name" UniqueName="clnSGName">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn AutoPostBackOnFilter="True" 
