<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjCost.aspx.cs" Inherits="YTD.ProjCost" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>[ Project Cost on Web ]</title>
    <style type="text/css">
...
<body >
    ...
    <tr>
    <td style="width:250px;">    <asp:Label ID="Label1" runat="server" Text="[ Project Cost ]" 
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" height="100%" 
            ...
            UniqueName="clnQty" DataType="System.Decimal" FooterText="Total :">
                        ...
                        <telerik:GridBoundColumn DataField="TOTALCOST" 
                            ...
                            UniqueName="clnTotalCost" Aggregate="Sum" DataType="System.Decimal">
                            <FooterStyle Font-Bold="True" ForeColor="#C04000" HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign ="Right" />
                        </telerik:GridBoundColumn>
              ...
              <telerik:GridBoundColumn DataField="MARGIN" 
                            FilterControlAltText="Filter clnTotalPrice column" HeaderText="Margin %" DataFormatString="{0:#00.000}%"
